...
private:
    ...
    JsonParseOps::JSON_CODES run_internal_parsing_operations(const std::string &response, const std::string &ticker_copy);
...
public:
    ...
    bool run_api_confirmation_window_operations(GLuint *out_texture, int *out_width, int *out_height);
